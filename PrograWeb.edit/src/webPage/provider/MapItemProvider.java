...
/**
 * This is the item provider adapter for a {@link webPage.Map} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Map_lat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Map_lat_feature", "_UI_Map_type"),
				 WebPagePackage.Literals.MAP__LAT,
				 true,
				 false,
				 false,
	...
	protected void addLongPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Map_long_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Map_long_feature", "_UI_Map_type"),
				 WebPagePackage.Literals.MAP__LONG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Map map = (Map)object;
		return getString("_UI_Map_type") + " " + map.getLat();
	}
