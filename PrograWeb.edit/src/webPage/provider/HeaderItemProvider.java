...
/**
 * This is the item provider adapter for a {@link webPage.Header} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HeaderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebPagePackage.Literals.HEADER__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addLogoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Header_logo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Header_logo_feature", "_UI_Header_type"),
				 WebPagePackage.Literals.HEADER__LOGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Header)object).getTitle();
